	...
	module ReturnLabel
		class Customer
			...
			def from_xml(root)
				...
				@address1 = @root.xpath("CustomerAddress1/text()").to_s
				@address2 = @root.xpath("CustomerAddress2/text()").to_s
			...
			def to_xml(xml)
				...
				xml.CustomerAddress1 @address1
				xml.CustomerAddress2 @address2
